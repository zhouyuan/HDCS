...
FLAGS = flags.FLAGS
FLAGS.register_opts(socket_opts)
...
class Server(object):
    ...
    def _get_socket(self, host, port, backlog):
        ...
        cert_file = FLAGS.ssl_cert_file
        key_file = FLAGS.ssl_key_file
        ca_file = FLAGS.ssl_ca_file
    ...
    def start(self, backlog=128):
        ...
        :returns: None
        :raises: hsm.exception.InvalidInput
        ...
        LOG.info("Started %(name)s on %(_host)s:%(_port)s" % self.__dict__)
...
class Application(object):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            [app:wadl]
            latest_version = 1.3
            paste.app_factory = hsm.api.fancy_api:Wadl.factory

        which would result in a call to the `Wadl` class as

            import hsm.api.fancy_api
...
class Middleware(Application):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            paste.filter_factory = hsm.api.analytics:Analytics.factory

        which would result in a call to the `Analytics` class as

            import hsm.api.analytics
...
class Loader(object):
    ...
    def load_app(self, name):
        ...
        :raises: `hsm.exception.PasteAppNotFound`
