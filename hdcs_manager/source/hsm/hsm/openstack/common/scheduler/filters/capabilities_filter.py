...
from hsm.openstack.common.scheduler import filters
from hsm.openstack.common.scheduler.filters import extra_specs_ops
...
class CapabilitiesFilter(filters.BaseHostFilter):
    ...
    def host_passes(self, host_state, filter_properties):
        ...
        # Note(zhiteng) Currently only Hsm and Nova are using
