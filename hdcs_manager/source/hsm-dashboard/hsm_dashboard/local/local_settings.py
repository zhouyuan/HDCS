...
# Default HSM Dashboard configuration.
HORIZON_CONFIG = {
    'dashboards': ('hsm',),
...
KEYSTONE_HSM_SERVICE_PASSWORD = "056e122005e0ad5c8bb1"
...
# external to the HSM environment. The default is 'internalURL'.
...
# of your entire HSM installation, and hopefully be in UTC.
TIME_ZONE = "UTC"
