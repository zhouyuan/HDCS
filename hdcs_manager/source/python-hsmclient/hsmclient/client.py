...
from hsmclient import service_catalog
from hsmclient import utils


class HTTPClient(object):

    USER_AGENT = 'python-hsmclient'

    def __init__(self, user, password, projectid, auth_url, insecure=False,
                 timeout=None, tenant_id=None, proxy_tenant_id=None,
                 proxy_token=None, region_name=None,
                 endpoint_type='publicURL', service_type=None,
                 service_name=None, hsm_service_name=None, retries=None,
        ...
        self.hsm_service_name = hsm_service_name
        ...
        if resp.status_code == 200:  # content must always present
            try:
                ...
                management_url = self.service_catalog.url_for(
                    ...
                    hsm_service_name=self.hsm_service_name)
    ...
    def authenticate(self):
        ...
        if self.version == "v2.0":
            ...
            # In some configurations hsm makes redirection to
...
def get_client_class(version):
    version_map = {
        '1': 'hsmclient.v1.client.Client',
        '2': 'hsmclient.v2.client.Client',
    }
    try:
